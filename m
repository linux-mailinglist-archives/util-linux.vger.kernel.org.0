...
Received: from localhost (localhost [127.0.0.1])
        by mail.vallenar.cl (Postfix) with ESMTP id 1AB8C1D0CAC7;
        Sun, 28 Nov 2021 15:36:22 -0300 (-03)
Received: from mail.vallenar.cl ([127.0.0.1])
        by localhost (mail.vallenar.cl [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id CEiHfjT2cZDM; Sun, 28 Nov 2021 15:36:22 -0300 (-03)
Received: from localhost (localhost [127.0.0.1])
        by mail.vallenar.cl (Postfix) with ESMTP id 91E811CAD406;
        Sun, 28 Nov 2021 13:48:52 -0300 (-03)
DKIM-Filter: OpenDKIM Filter v2.10.3 mail.vallenar.cl 91E811CAD406
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=vallenar.cl;
        s=EC098874-C7DE-11E7-B3B1-1A9A6030413E; t=1638118132;
        bh=IQxUcKgLaEia+DMrVj9OEHbWOH8TffrzQMeZgAxYubI=;
        h=MIME-Version:To:From:Date:Message-Id;
        b=
X-Virus-Scanned: amavisd-new at vallenar.cl
Received: from mail.vallenar.cl ([127.0.0.1])
        by localhost (mail.vallenar.cl [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id bXMDMz4EgybD; Sun, 28 Nov 2021 13:48:52 -0300 (-03)
Received: from [192.168.8.101] (unknown [105.0.3.102])
        by mail.vallenar.cl (Postfix) with ESMTPSA id 0FE1F1CAA8B1;
        Sun, 28 Nov 2021 11:38:52 -0300 (-03)
...
Date:   Sun, 28 Nov 2021 16:46:23 +0200
Reply-To: manuelfrancospende00@gmail.com
Message-Id: <20211128143854.0FE1F1CAA8B1@mail.vallenar.cl>
Precedence: bulk
